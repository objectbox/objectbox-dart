...
void main() {
  ...
  test('store box vending', () {
    ...
    // int putId = env.box.put(TestEntity(tString: 'foo'));
    // int putId = env.box.put(TestEntity.index(iString: '', iLong: 1, iInt: 1, iShort: 1, iByte: 1, iChar: 1));
    int putId = store.box<TestEntity2>().put(TestEntity2(id: 1));
  ...
  // test('.getMany correctly handles non-existent items', () {
    // box.put(TestEntity(tString: 'One'));
    // final List<TestEntity> items =

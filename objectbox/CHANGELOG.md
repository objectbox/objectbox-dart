...
* Update: [objectbox-swift 1.8.0](https://github.com/objectbox/objectbox-swift/releases/tag/v1.8.0).
  Note that for this release `sync_flutter_libs` does not support macOS and iOS, please stick to
  ObjectBox Dart 1.6.2.

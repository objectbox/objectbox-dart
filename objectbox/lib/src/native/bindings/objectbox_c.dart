...
// Pinned to a pre-3.0 language version: this ffigen output predates Dart 3
// class modifiers (Struct/Opaque subtypes must be `final` from 3.0 on) and
// the package minimum SDK is now 3.4 (for web support). Remove when the
// bindings are regenerated with a current ffigen.
// @dart=2.19

...
late final _dart_memset memset =
    _lib!.lookupFunction<_c_memset, _dart_memset>('memset');
...
late final _dart_memcpy memcpy =
    _lib!.lookupFunction<_c_memcpy, _dart_memcpy>('memcpy');

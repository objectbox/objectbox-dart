...
OBX_C_API OBX_sync_msg_objects_builder* obx_sync_msg_objects_builder(const uint8_t* topic, size_t topic_size);
...
OBX_C_API obx_err obx_sync_msg_objects_builder_add(OBX_sync_msg_objects_builder* message, OBXSyncObjectType type,
                                                   const uint8_t* data, size_t size, uint64_t id);
...
OBX_C_API obx_err obx_custom_msg_server_receive_message_from_client(uint64_t server_id, uint64_t client_connection_id,
                                                                    const uint8_t* message_data, size_t message_size);
...
/// @returns OBX_ERROR_* in case the operation encountered an exceptional issue
OBX_C_API obx_err obx_custom_msg_client_receive_message_from_server(uint64_t client_id, const uint8_t* message_data,
                                                                    size_t message_size);

...
OBX_C_API obx_err obx_bytes_lazy_get(OBX_bytes_lazy* bytes, const uint8_t** out_bytes, size_t* out_size);
...
OBX_C_API obx_err obx_opt_model_bytes(OBX_store_options* opt, const uint8_t* bytes, size_t size);
...
OBX_C_API obx_err obx_opt_model_bytes_direct(OBX_store_options* opt, const uint8_t* bytes, size_t size);
...
OBX_C_API obx_err obx_tree_cursor_get_raw(OBX_tree_cursor* cursor, const char* path, const uint8_t** data, size_t* size,

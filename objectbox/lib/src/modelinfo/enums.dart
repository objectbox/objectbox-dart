...
int externalTypeToOBXExternalType(ExternalPropertyType type) {
  switch (type) {
    ...
    case ExternalPropertyType.uuidString:
      return OBXExternalPropertyType.UuidString;
    case ExternalPropertyType.uuidV4:
      return OBXExternalPropertyType.UuidV4;
    case ExternalPropertyType.uuidV4String:
      return OBXExternalPropertyType.UuidV4String;

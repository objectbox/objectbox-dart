...
class Reference {
  ...
  int _readInt(int offset, BitWidth width) {
    ...
    return _getInt64Js(_buffer, offset);
  }
  ...
  int _readUInt(int offset, BitWidth width) {
    ...
    return _getUint64Js(_buffer, offset);
  }
...
// JavaScript-safe 64-bit integer accessors (see file header).
int _getInt64Js(ByteData buffer, int offset) {
  final lo = buffer.getUint32(offset, Endian.little);
  final hi = buffer.getInt32(offset + 4, Endian.little);
  return hi * 4294967296 + lo;
}

int _getUint64Js(ByteData buffer, int offset) {
  final lo = buffer.getUint32(offset, Endian.little);
  final hi = buffer.getUint32(offset + 4, Endian.little);
  return hi * 4294967296 + lo;
}

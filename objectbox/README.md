...
| ------------------------------------ | ----------------: | -------------: | ------------: | 
| APK (default compressed, arm64-v8a)  |           5.5 MiB |        6.0 MiB |      +0.5 MiB |
| APK (uncompressed, arm64-v8a)*       |          12.0 MiB |       13.5 MiB |  **+1.5 MiB** |
| Fat APK (uncompressed, all ABIs)     |          33.8 MiB |       39.6 MiB |      +5.8 MiB |

(*) This is also about the size an APK generated by Google Play would be when uploading an App Bundle (`flutter build appbundle`).

...
class Box<T> {
  ...
  /*
  QueryBuilder queryAnyCondition(List<QueryCondition> qc) {
    // TODO qc.asQueryBuilder(_store, _entityDefinition["entity"]["id"]);
  }

  QueryBuilder queryAllConditions(List<QueryCondition> qc) {
    // TODO qc.asQueryBuilder(_store, _entityDefinition["entity"]["id"]);
  }
  */

...
class ObjectBox {
  ...
  void _putDemoData() {
    Tag tag1 = Tag('work', desc: "This is a work tag.");
    Tag tag2 = Tag('study', desc: "This is a study tag.");
  ...
  Future<int> addTag(String name) async {
    ...
    final newTagId = await _tagBox.putAsync(
      Tag(name, desc: "This is a new tag."),
    );
